...
<template>
  <div class="h-full flex flex-col overflow-hidden">
    <!-- Header -->
    <header
      class="flex-shrink-0 text-center py-3 md:py-4 px-4 border-b border-gold/15"
    >
      ...
      <div class="max-w-lg mx-auto space-y-6">
          ...
          <section>
            ...
            <div class="space-y-3">
              ...
              <div class="glass-card p-4 flex items-center justify-between">
                ...
                <span
                  class="px-3 py-1.5 bg-gold/15 text-gold rounded-full text-sm"
                >
                  {{ reversedPercent }}%
                </span>
              </div>
              ...
              <div class="glass-card p-4">
                ...
                <p class="text-xs text-muted-foreground mt-2 pl-1">
                  {{
                    deckRangeOptions.find((o) => o.value === useFullDeck)
                      ?.description
                  }}
                </p>
              </div>
        ...
        >
          <section>
            ...
            >
              <p>
                本应用基于经典的<span class="text-gold">韦特塔罗</span
                >（Rider-Waite Tarot）， 由亚瑟·韦特于 1909 年设计。
              </p>
              <p>
